...
<html lang="en">
    <head>
        ...
        <title>Login - SMA Pemalang</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">Login - SMA Pemalang</h4></div>
                                    <div class="card-body">
                                        <form action="proseslogin.php" method="POST">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" type="password" placeholder="Password" minlength="4" name="password"
                                                required/>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="txt-muted small">Copyright &copy; SMA Pemalang <?= date("Y") ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
