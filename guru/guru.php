...
$alert = '';
 if ($msg == 'updated') {
    $alert = '<div class="alert alert-succes alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-circle-check"></i> Data guru berhasil diupdated
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
...
$alert = '';
 if ($msg == 'cancel') {
    ...
    <i class="fa-solid fa-circle-xmark"></i> Data guru tidak berhasil diupdated
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card">
                ...
                <a href="<?= $main_url ?>guru/add-guru.php" class="btn btn-sm btn-primary float-end"><i class="fa-solid fa-square-plus"></i> Tambah Guru</a>
                </div>
                <div class="card-body">
                    <table class="table table-hover" id="datatablesSimple">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?= $data['alamat'] ?></td>
                                <td align="center">
                                    <a href="edit-guru.php?id=<?=$data['id'] ?>" class="btn btn-sm btn-info" title="update guru"><i class="fa-solid fa-pen"></i></a>
