<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= $main_url ?>">SMA Pemalang</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0 ms-1" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-contro border-0 bg-transparent" id="nama" value=": <?= $profile['nama']?>" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label for="jabatan" class="col-sm-3 col-form-label pe-0">Jabatan</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly class="form-contro border-0 bg-transparent" id="jabatan" value=": <?= $profile['jabatan']?>" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
