...
$title = "Nilai Ujian - SMA Pemalang";
...
$alert = '';
 if ($msg == 'LULUS') {
    ...
    <i class="fa-solid fa-circle-check"></i> Selamat Siswa dengan NIS: ' . $nis . ' lulus
...
if ($msg == 'GAGAL') {
    ...
    <i class="fa-solid fa-circle-xmark"></i> Maaf Siswa dengan NIS: ' . $nis . ' gagal
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}

$querNoUjian = mysqli_query($koneksi, "SELECT max(no_ujian) as maxno FROM tbl_ujian");
$data = mysqli_fetch_array($querNoUjian);
$maxno = $data['maxno'];
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Nilai ujian siswa</li>
                    </ol>
                </div>
                <div class="col-md-5">
                    <div class="card mt-3 border-0">
                        <h5>Syarat lulus bagi siswa</h5>
                        <ul class="ps-3">
                            <li><small>Nilai minimal setiap matpel tidak boleh dibawah 50</small></li>
                            <li><small>Nilai rata-rata matpel tidak boleh dibawah 60</small></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <form action="proses-ujian.php" method="POST">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa-solid fa-square-plus"></i> Data Peserta Ujian
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <i class="fa-solid fa-list"></i> Input Nilai Ujian Siswa
                                <button type="submit" name="simpan" class="btn btn-sm btn-info float-end"><i class="fa-solid fa-floppy-disk"></i> Simpan</button>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tbody id="kejuruan">
                                            <!-- Data Nilai Ujian Siswa Akan Muncul Di Sini -->
                                        </tbody>
                                    </table>
                                </div>
                            </div>
